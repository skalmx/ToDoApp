...
func NewTasksRepo(db *sql.DB) *Tasks {
	return &Tasks{db}
}

func (t *Tasks) Create(ctx context.Context, task domain.TaskInput ) (int64, error) {
...
func (t *Tasks) GetAll(ctx context.Context, listId int64) ([]domain.Task, error) {
...
func (t *Tasks) GetOne(ctx context.Context, listId int64, taskId int64) (domain.Task, error) {
	var task domain.Task
...
func (t *Tasks) Delete(ctx context.Context, listId int64, taskId int64) error {
...
func (t *Tasks) Update(ctx context.Context, input domain.TaskInput, taskId int64) error {
